...
cor_matrix <- cor(correlates_bs, use = "complete.obs", method = "pearson")
...
cor_matrix <- cor(correlates_bs, use = "pairwise.complete.obs")
...
### BSthought rating and listing and others
```{r}
