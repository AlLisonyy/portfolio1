...
##5. BFSp and Narcissistic Personality Inventory
pcor.test(Thesis_scale$BFSp_score, Thesis_scale$narc_score, Thesis_scale$LIE_score)
...
##5. BFSe and Narcissistic Personality Inventory
pcor.test(Thesis_scale$BFSe_score, Thesis_scale$narc_score, Thesis_scale$LIE_score)
