...
Thesis_scale <- Thesis_clean %>%
  mutate(
    ...
    across(c(self_esteem_2, self_esteem_5, self_esteem_6, self_esteem_8, self_esteem_9), ~ recode(., 
      `1` = 4, `11` = 3, `12` = 2, `13` = 1)), ##Thought-Rating
...
Thesis_scale <- Thesis_scale %>%
  mutate(
    ...
    sum_recoded_TR_college = rowSums(select(., CG1_score, CG2_score, CG3_score, CG4_score, CG5_score), na.rm = TRUE),
    sum_recoded_TR_recycling = rowSums(select(., CG1_score, CG2_score, CG3_score, CG4_score, CG5_score), na.rm = TRUE),
    sum_recoded_TR_crime = rowSums(select(., CG1_score, CG2_score, CG3_score, CG4_score, CG5_score), na.rm = TRUE),
    recoded_recycling = rowSums(select(., RC1_score, RC2_score, RC3_score, RC4_score, RC5_scoree), na.rm = TRUE),
