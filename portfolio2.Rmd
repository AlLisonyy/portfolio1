...
library(tidyverse)
library(dplyr)
Thesis <- read_sav("~/Desktop/THESIS/Thesis.sav")    
```
...
Thesis_scale <- Thesis_scale %>%
  mutate(BSthought = (BSthought_college + BSthought_recycling + BSthought_crime)/ 3)
...
Thesis_scale$ns1 <- ifelse(Thesis_scale$NS1 == 500, 1, 0)
Thesis_scale$ns2 <- ifelse(Thesis_scale$NS2 == 10, 1, 0)
Thesis_scale$ns3 <- ifelse(Thesis_scale$NS3 == 0.1, 1, 0)
Thesis_scale$ns4 <- ifelse(Thesis_scale$NS4 == 9, 1, 0)
Thesis_scale$ns5 <- ifelse(Thesis_scale$NS5 == 8, 1, 0)
Thesis_scale$ns6 <- ifelse(Thesis_scale$NS6 == 2, 1, 0)
Thesis_scale$ns7 <- ifelse(Thesis_scale$NS7 == 2, 1, 0)
Thesis_scale$ns8 <- ifelse(Thesis_scale$NS8 == 10, 1, 0)
Thesis_scale$ns9 <- ifelse(Thesis_scale$NS9 == 100, 1, 0)
Thesis_scale$ns10 <- ifelse(Thesis_scale$NS10 == 20, 1, 0)
Thesis_scale$ns11 <- ifelse(Thesis_scale$NS11 == 5, 1, 0)
##calculate the mean of each question they got right
Thesis_scale <- Thesis_scale %>%
  mutate(NS_score = (ns1 + ns2 + ns3 + ns4 + ns5 + ns6 + ns7 + ns8 + ns9 + ns10)/ 10)
