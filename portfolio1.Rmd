...
```
Before looking at the houses location visualization, I merged Winston-Salem to Winston. After that, I wanted to check which cities in NC has the most or least haunted houses. Asheville appeared to have the most 
...
ggplot(top_haunted_cities, aes(x = city, y = num_haunted_houses, colour = city, fill = city)) +
  ...
  coord_flip()
```
```{r top 10 cities in NC visualized location}
